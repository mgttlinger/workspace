...
class ImagePanel(val modell: Model) extends JPanel with Observer {
  ...
  override def paint(g: Graphics) {
    ...
    for {
      ...
      if invertP1._1 >= -getWidth && invertP1._1 < 2*getWidth
      if invertP2._1 >= -getWidth && invertP2._1 < 2*getWidth
      if invertP1._2 >= -getHeight && invertP1._2 < 2*getHeight
      if invertP2._2 >= -getHeight && invertP2._2 < 2*getHeight
    }{
